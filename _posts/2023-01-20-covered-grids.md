...
% Example 8-by-8 Colored Top Half %{
...
% Example 8-by-8 Working Backwards %{
...
% shoutout to https://teth-main.github.io/GraTeX/ for letting me not drudge through figuring out the LaTeX plotting packages!

\begin{figure}[hbtp]
    \includegraphics[width=\linewidth]{GraTeX.png}
\end{figure}
